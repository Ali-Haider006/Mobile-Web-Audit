...
CREATE TABLE IF NOT EXISTS pages (
    ...
    clickup_list_id         VARCHAR(64)   DEFAULT NULL COMMENT 'per-URL override of the site list',
    clickup_assignee_id     INT UNSIGNED  DEFAULT NULL,
    consecutive_errors      TINYINT UNSIGNED NOT NULL DEFAULT 0,
    error_alerted_at        DATETIME      DEFAULT NULL,
    PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    previous_task_id  INT UNSIGNED DEFAULT NULL COMMENT 'the task this one succeeds',
